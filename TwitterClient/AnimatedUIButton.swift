...
//        ]
    ...
    func touchDown(sender: AnimatedUIButton) {
        self.layer.opacity = 0.4
    }
    func touchUpInside(sender: AnimatedUIButton) {
        self.layer.opacity = 1.0
    }
    func touchDragExit(sender: AnimatedUIButton) {
        self.layer.opacity = 1.0
    }
    func touchDragEnter(sender: AnimatedUIButton) {
        self.layer.opacity = 0.4
    }
    func touchCancel(sender: AnimatedUIButton) {
        self.layer.opacity = 1.0
    }
